...
'''
Implementation of Average Drop and Increase metrics.
'''
...
def get_class_name(c):
    labels = np.loadtxt('../storage/imagenet_classes/synset_words.txt', str, delimiter='\t')           #------> GIVE YOUR PATH
    return ' '.join(labels[c].split(',')[0].split()[1:])
    #/data1/data/expes/dreppas
